	...
	<body>
 	<div data-demo-html="true">
		<div data-role="header">
			...
			<a href="#" onClick='gotoNewUrl("purchase_order_print.php","<?=$eDate?>","<?=$Fl?>");' class="ui-btn-right ui-btn ui-btn-b ui-btn-inline ui-mini  ui-btn-icon-right ui-icon-grid">Print</a>
